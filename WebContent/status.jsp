            ...
            <div id="gbox-bg">
             ...
             <br/>
              <% 
                ...
                PreparedStatement ps= con.prepareStatement("select vid,source,destination,tvehicle,chargetruck,status from truckinfo order by vid desc ");
               	ResultSet rs= ps.executeQuery();
               	out.print("<table cellspacing='3',cellpadding='3' border='3'>");
               	out.print("<tr><th><center>Vehicle Number<center></th><th><center>Source</center></th><th><center>Destination</center></th><th><center>Type of Vehicle</center></<th><th><center>Status</center></th></tr>");
               	while(rs.next()){
               	out.print("<tr>");
